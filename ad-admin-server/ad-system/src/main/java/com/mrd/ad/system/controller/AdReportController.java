...
public class AdReportController {
    ...
    @PostMapping("/api/devices/viitalk/play/report")
    public ApiResult<AdPlayReportResult> reportDevicePlay(@Validated @RequestBody AdPlayReportRequest request) {
        return ApiResult.success(adReportService.reportDevicePlay(request));
    }
}
